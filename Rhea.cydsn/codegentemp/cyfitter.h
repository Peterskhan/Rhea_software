...
#define UART_TX_INTR__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define UART_TX_INTR__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define UART_TX_INTR__INTC_MASK 0x10u
#define UART_TX_INTR__INTC_NUMBER 4u
#define UART_TX_INTR__INTC_PRIOR_NUM 7u
#define UART_TX_INTR__INTC_PRIOR_REG CYREG_NVIC_PRI_4
#define UART_TX_INTR__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define UART_TX_INTR__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
